      ...
      <script type="text/javascript">
         $(document).ready(function(){
            ...
            function validation(){ 
               ...
               if(contents === '<p>&nbsp;</p>' || contents === '' || contents === '<br>' || contents === '사진과 글을 원하는 위치에 이쁘게 꾸며주세요!<br>사진은 우측 상단 버튼을 이용해서 넣어주세요!' || contents === '<p>사진과 글을 원하는 위치에 이쁘게 꾸며주세요!<br>사진은 우측 상단 버튼을 이용해서 넣어주세요!</p>'){ // 기본적으로 아무것도 입력하지 않아도 값이 입력되어 있음. 
                  swal({
                     text:"글 내용을 입력해주세요.",
                     buttons:{"확인":true}
                  }).then((value) => {
                     if(value){
                        document.reviewFrm.b_content.focus();
                     }
                  });
